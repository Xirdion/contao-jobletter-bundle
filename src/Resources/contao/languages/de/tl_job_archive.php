...
$GLOBALS['TL_LANG'][$table]['mail_text'] = ['Inhalt', 'Hier können Sie den Inhalt der E-Mail eingeben. Sie können die Platzhalter <em>##email##</em> (E-Mail-Adresse des Empfängers), <em>##archive##</em> (Name des Archivs), <em>##categories##</em> (Namen der Kategorien), <em>##job##</em> (Titel des Jobs), <em>##job_link##</em> (Link zum Jobs) und <em>##unsubscribe_link##</em> (Link zum Abmelden) verwenden.'];
$GLOBALS['TL_LANG'][$table]['mail_unsubscribe_link'] = ['Abmeldelink', 'Wählen Sie die Seite aus, auf der man sich vom Job-Letter abmelden kann.'];
