...
$GLOBALS['TL_LANG'][$table]['jl_addJumpMark'] = ['Sprungmarke hinzufügen', 'Soll beim Bestätigungslink eine Sprungmarke zum Modul hinzugefügt werden?'];
...
$GLOBALS['TL_LANG'][$table]['text_legend'] = 'Text-Einstellungen für die Anmeldung zum Jobradar';
